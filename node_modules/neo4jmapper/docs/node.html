 ...
 */</span>
<span class="keyword">var</span> __initNode__ = <span class="keyword">function</span>(neo4jrestful, Graph) {
...
TODO: find a solution for bson object id</p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">var</span> helpers               = window.Neo4jMapper.helpers;
   ...
   */</span>
  <span class="keyword">var</span> Node = <span class="function"><span class="keyword">function</span> <span class="title">Node</span><span class="params">(data, id, cb)</span> {</span></pre></div></div>
      ...
      <span class="keyword">this</span>._constructor_name_ = helpers.constructorNameOfFunction(<span class="keyword">this</span>) || <span class="string">'Node'</span>;
    <span class="keyword">this</span>.init(data, id);
   ...
   */</span>
  Node.prototype.init = <span class="keyword">function</span>(data, id) {
    <span class="keyword">this</span>.setId(id || <span class="literal">null</span>);
  ...
  <span class="comment">/** Instantiate a node from a specific model
    * Model can be a constructor() or a String
    * and must be registered in Node.registered_models()
    *
    * @param {Function|String}
    */</span>
  Node.prototype.convertToModel = <span class="keyword">function</span>(model) {
    <span class="keyword">var</span> Class = <span class="keyword">this</span>.recommendConstructor();
    <span class="keyword">if</span> (<span class="keyword">typeof</span> model === <span class="string">'function'</span>) {
      Class = model;
    } <span class="keyword">else</span> <span class="keyword">if</span> ((<span class="keyword">typeof</span> model === <span class="string">'string'</span>) &amp;&amp; (Node.registeredModel(model))) {
      Class = Node.registeredModel(model);
    }
    <span class="keyword">var</span> node = <span class="keyword">new</span> Class();
    <span class="keyword">this</span>.copyTo(node);
    <span class="keyword">return</span> node;
        ...
        <li id="section-7">
            <div class="annotation">
              ...
              <p>if we have a distinct label, we will create a model from of it</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>  Node.instantiateNodeAsModel = <span class="keyword">function</span>(node, labels, label) {
    <span class="keyword">var</span> model = label;</pre></div></div>
        ...
        <li id="section-8">
            <div class="annotation">
              ...
              <p>if we have given explicit a specific model</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> (<span class="keyword">typeof</span> labels === <span class="string">'string'</span>) {
      model = labels;
    }</pre></div></div>
        ...
        <li id="section-9">
            <div class="annotation">
              ...
              <p>alternative: if we have only one label we instantiate from this</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> ((labels) &amp;&amp; (labels.length === <span class="number">1</span>))
      model = labels[<span class="number">0</span>];
...
TODO: implement unique</p>
  ...
  Node.prototype._hashedData_     = <span class="literal">null</span>;           <span class="comment">// contains md5 hash of a persisted object</span>
  Node.prototype.Relationship     = <span class="literal">null</span>;           <span class="comment">// constructor object for Relationship()</span></pre></div></div>
        ...
        <li id="section-11">
            <div class="annotation">
              ...
              <p>cypher properties will be <strong>copied</strong> on each new object on cypher.segments in resetQuery()</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>  Node.cypherStatementSegments = {
    ...
    count: <span class="string">''</span>,              <span class="comment">// count(n) (DISTINCT)</span></pre></div></div>
        ...
        <li id="section-12">
            ...
            <div class="content"><div class='highlight'><pre>    _optionalMatch: <span class="literal">null</span>,
    _count: <span class="literal">null</span>,
    _distinct: <span class="literal">null</span>,
    by_id: <span class="literal">null</span>
  };

  Node.prototype.ignoreExceptionPattern   = <span class="regexp">/^EntityNotFoundException$/</span>; <span class="comment">// will be used ONLY on findById</span>
  ...
  Node.prototype.__skip_loading_labels__  = <span class="literal">null</span>;   <span class="comment">// is used in _onBeforeLoad() to prevent loading labels in an extra request</span>
   ...
   * e.g. n = node(*)
   */</span>
  Node.prototype.__TYPE__                 = <span class="string">'node'</span>;
...
The callback can be used to ensure that all async processes are finished</p>
    ...
    <span class="keyword">return</span> <span class="keyword">this</span>.onBeforeInitialize(<span class="keyword">function</span>(err, res, debug) {
      <span class="keyword">if</span> (err)
        cb(err, <span class="literal">null</span>, debug);
      <span class="keyword">else</span>
        self.onAfterInitialize(cb);
    });
  }

  Node.prototype.onBeforeInitialize = <span class="keyword">function</span>(next) {
    <span class="keyword">return</span> next(<span class="literal">null</span>,<span class="literal">null</span>,<span class="literal">null</span>);
  }

  Node.prototype.onAfterInitialize = <span class="keyword">function</span>(cb) {</pre></div></div>
...
because it is expected at <code>Node.register_model(&#39;Label&#39;, cb)</code></p>
    ...
    <span class="keyword">if</span> (label) {
      <span class="keyword">if</span> (fieldsToIndex.length &gt; <span class="number">0</span>) {
        <span class="keyword">return</span> node.ensureIndex({ label: label, fields: fieldsToIndex }, <span class="keyword">function</span>(err, res, debug) {
          <span class="keyword">return</span> cb(err, self.constructor, debug);
        });
      } <span class="keyword">else</span> {
        <span class="keyword">return</span> cb(<span class="literal">null</span>, self.constructor, <span class="literal">null</span>);
      }
    } <span class="keyword">else</span> {
      <span class="keyword">return</span> cb(Error(<span class="string">'No label found'</span>), <span class="keyword">this</span>.constructor, <span class="literal">null</span>);
    }
  }</pre></div></div>
   ...
   */</span>
  Node.prototype.resetQuery = <span class="keyword">function</span>() {</pre></div></div>
        ...
        <li id="section-18">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">this</span>.cypher = <span class="keyword">new</span> CypherQuery();
    <span class="keyword">this</span>.cypher.segments = {};
    _.extend(<span class="keyword">this</span>.cypher.segments, <span class="keyword">this</span>.constructor.cypherStatementSegments);
    <span class="keyword">this</span>.cypher.segments.where = [];
    <span class="keyword">this</span>.cypher.segments.hasProperty = [];
    <span class="keyword">this</span>.cypher.segments.match = [];
    <span class="keyword">this</span>.cypher.segments.return_properties = [];
    <span class="keyword">this</span>.cypher.segments.start = {};
    <span class="keyword">this</span>._query_history_ = [];
    <span class="keyword">if</span> (<span class="keyword">this</span>.id)
      <span class="keyword">this</span>.cypher.segments.from = <span class="keyword">this</span>.id;
  ...
  Node.prototype.dataForCypher = <span class="keyword">function</span>() {
    <span class="keyword">var</span> data = <span class="keyword">this</span>.flattenData();
    <span class="keyword">for</span> (<span class="keyword">var</span> attr <span class="keyword">in</span> data) {
      data[<span class="string">'`'</span>+attr+<span class="string">'`'</span>] = data[attr];
      <span class="keyword">delete</span> data[attr];
    }
    <span class="keyword">return</span> data;
  }
  ...
  Node.prototype.hasValidData = <span class="keyword">function</span>() {
    <span class="keyword">return</span> helpers.isObjectLiteral(<span class="keyword">this</span>.data);
  }
   ...
   * }});
   */</span>
  Node.prototype.uniqueFields = <span class="keyword">function</span>() {
    <span class="keyword">var</span> keys = [];
   ...
   */</span>
  Node.prototype.ensureIndex = <span class="keyword">function</span>(options, cb) {
    ...
    <span class="keyword">var</span> self    = <span class="keyword">this</span>;
    <span class="keyword">var</span> keys    = _.uniq(_.union(options.fields, options.unique)); <span class="comment">// merge index + unique here</span>
    <span class="keyword">var</span> todo    = keys.length;
    ...
    <span class="keyword">if</span> (!options.label)
      <span class="keyword">throw</span> Error(<span class="string">'Label is mandatory, you can set the label as options as well'</span>);
...
TODO: find a way to distinct index</p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">this</span>.getIndex(<span class="keyword">function</span>(err, indexedFields, debug) {</pre></div></div>
      ...
      _.each(keys, <span class="keyword">function</span>(key){
        ...
        <span class="keyword">var</span> after = <span class="keyword">function</span>(err, res) {
          ...
          <span class="keyword">if</span> ((err === <span class="string">'object'</span>) &amp;&amp; (err !== <span class="literal">null</span>)) {</pre></div></div>
        ...
        <li id="section-27">
            <div class="annotation">
              ...
              <p>we transform the given error(s) to an array to iterate through it</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>            <span class="keyword">var</span> errAsArray = (err.length &gt; <span class="number">0</span>) ? err : [ err ];
            errAsArray.forEach(<span class="keyword">function</span>(err) {
        ...
        <li id="section-28">
          ...
          <span class="keyword">if</span> (done === todo) {
            cb((errors.length &gt; <span class="number">0</span>) ? errors : <span class="literal">null</span>, results, debug);
          }
        };
  ...
  Node.prototype.getIndex = <span class="keyword">function</span>(cb) {
    ...
    <span class="keyword">return</span> Graph.request().get(url, <span class="keyword">function</span>(err, res, debug){
      <span class="keyword">if</span> ((<span class="keyword">typeof</span> res === <span class="string">'object'</span>) &amp;&amp; (res !== <span class="literal">null</span>)) {
        ...
        _.each(res, <span class="keyword">function</span>(data){
          <span class="keyword">if</span> (data.label === label)
            keys.push(data[<span class="string">'property_keys'</span>]);
        });
        <span class="keyword">return</span> cb(<span class="literal">null</span>, _.flatten(keys), debug);
      } <span class="keyword">else</span> {
  ...
  Node.prototype.save = <span class="keyword">function</span>(cb) {
    ...
    <span class="keyword">return</span> self._onBeforeSave(self, <span class="keyword">function</span>(err) {</pre></div></div>
  ...
  Node.prototype._onBeforeSave = <span class="keyword">function</span>(node, next) {
    <span class="keyword">this</span>.onBeforeSave(node, <span class="keyword">function</span>(err) {
      next(err);
    });
  }

  Node.prototype.onBeforeSave = <span class="keyword">function</span>(node, next) {
    ...
    <span class="keyword">if</span> (<span class="keyword">this</span>.id &gt; <span class="number">0</span>) {</pre></div></div>
        ...
        <li id="section-33">
            <div class="annotation">
              ...
              <p>we generate: { n: { data } } -&gt; n.<code>prop</code> = &#39;&#39; , … ,
update node</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      Graph
        .start(<span class="string">'n = node({id})'</span>)
        .addParameter({ id: Number(<span class="keyword">this</span>.id) })
        .setWith({ n: <span class="keyword">this</span>.dataForCypher() })
        .exec(<span class="keyword">function</span>(err, res, debug) {
          <span class="keyword">if</span> (err) {
            <span class="keyword">return</span> cb(err, res, debug);
          } <span class="keyword">else</span> {
        ...
        <li id="section-34">
            ...
            <div class="content"><div class='highlight'><pre>      <span class="keyword">var</span> labels = (<span class="keyword">this</span>.labels.length &gt; <span class="number">0</span>) ? <span class="string">':'</span>+<span class="keyword">this</span>.labels.join(<span class="string">':'</span>) : <span class="string">''</span>;
      <span class="keyword">var</span> data = {};
      data[<span class="string">'n'</span>+labels] = <span class="keyword">this</span>.dataForCypher();
      Graph
        .start()
        .create(data)
        .<span class="keyword">return</span>(<span class="string">'n'</span>)
        .limit(<span class="number">1</span>)
        .exec(<span class="keyword">function</span>(err, res, debug) {
          <span class="keyword">if</span> ((err)||(!res)) {
            <span class="keyword">return</span> cb(err, res, debug);
          } <span class="keyword">else</span> {
            <span class="keyword">var</span> node = res;</pre></div></div>
  ...
  Node.prototype._onAfterSave = <span class="keyword">function</span>(err, node, next, debug) {
    <span class="keyword">this</span>.onAfterSave(err, node, <span class="keyword">function</span>(err, node, debug) {</pre></div></div>
...
cypher inappropriate since it can&#39;t handle { attributes.with.dots: &#39;value&#39; } …</p>
  ...
  Node.prototype.onAfterSave = <span class="keyword">function</span>(err, node, next, debug) {
    <span class="keyword">return</span> next(err, node, debug);
  }

  Node.prototype.update = <span class="keyword">function</span>(data, cb) {
    <span class="keyword">if</span> (!<span class="keyword">this</span>._is_singleton_) {
      <span class="keyword">return</span> <span class="keyword">this</span>.constructor.findById(<span class="keyword">this</span>._id_).update(data, cb);
    }
    ...
    <span class="keyword">if</span> (!helpers.isObjectLiteral(data)) {
      <span class="keyword">throw</span> Error(<span class="string">'To perform an .update() you need to pass a valid data object literal as first argument'</span>);
    }

    data = helpers.flattenObject(data);
    <span class="keyword">this</span>.cypher.segments.set = [];
    ...
    <span class="keyword">this</span>.cypher.segments._update_ = <span class="literal">true</span>; <span class="comment">// update flag is used in graph._processResults</span>
    <span class="keyword">this</span>.cypher.segments.start[<span class="keyword">this</span>.__TYPE_IDENTIFIER__] =  <span class="keyword">this</span>.__TYPE__ + <span class="string">'('</span> + <span class="keyword">this</span>.cypher.segments.by_id + <span class="string">')'</span>;
  ...
  Node.prototype.addSetDefinition = <span class="keyword">function</span>(attribute, value) {
    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.useParameters) {
      ...
      parameter[key] = value;
      <span class="keyword">this</span>.cypher.segments.set.push(
      ...
      <span class="keyword">this</span>.cypher.segments.set.push(helpers.cypherKeyValueToString(attribute, value, <span class="keyword">this</span>.__TYPE_IDENTIFIER__));
    }
  }

  Node.prototype.load = <span class="keyword">function</span>(cb, debug) {
    <span class="keyword">var</span> self = <span class="keyword">this</span>;
    <span class="keyword">return</span> <span class="keyword">this</span>._onBeforeLoad(self, <span class="keyword">function</span>(err, node) {
      <span class="keyword">if</span> (err)
        cb(err, node, debug);
      <span class="keyword">else</span>
  ...
  Node.prototype._onBeforeLoad = <span class="keyword">function</span>(node, next, debug) {
    <span class="keyword">this</span>.onBeforeLoad(node, <span class="keyword">function</span>(node) {
      <span class="keyword">if</span> (node.hasId()) {

        <span class="keyword">var</span> _createNodeFromLabel = <span class="keyword">function</span>(node, debug) {
          node.isPersisted(<span class="literal">true</span>);
          node.__skip_loading_labels__ = <span class="literal">null</span>;
          next(<span class="literal">null</span>, node, debug);
        }

        <span class="keyword">if</span> (node.__skip_loading_labels__) {
        ...
        <li id="section-42">
            <div class="annotation">
              ...
              <p>only load labels if it&#39;s set to not loaded</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>          <span class="keyword">return</span> node.allLabels(<span class="keyword">function</span>(err, labels, debug) {
            <span class="keyword">if</span> (err)
        ...
        <span class="keyword">return</span> next(<span class="literal">null</span>, node);
      }
    });
  }

  Node.prototype.reload = <span class="function"><span class="keyword">function</span> <span class="params">(cb)</span> {</span>
    <span class="keyword">this</span>._is_loaded_ = <span class="literal">false</span>;
    <span class="keyword">this</span>.load(cb);
  }

  Node.prototype.onBeforeLoad = <span class="keyword">function</span>(node, next) {
    <span class="keyword">return</span> next(node);
  }

  Node.prototype._onAfterLoad = <span class="keyword">function</span>(node, next) {
    node._is_loaded_ = <span class="literal">true</span>;
    <span class="keyword">this</span>.onAfterLoad(node, <span class="keyword">function</span>(err, node) {
      next(err, node);
    });
  }
...
RETURN p</p>
        ...
        <li id="section-49">
            <div class="annotation">
              ...
              <p>this.cypher.segments.start = {};</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      <span class="keyword">this</span>.cypher.segments.start.a = <span class="string">'node('</span>+start+<span class="string">')'</span>;
      <span class="keyword">this</span>.cypher.segments.start.b = <span class="string">'node('</span>+end+<span class="string">')'</span>;
      ...
      <span class="keyword">this</span>.cypher.segments.match = [ matchString.replace(<span class="regexp">/\[\:\*+/</span>, <span class="string">'[*'</span>) ];
      <span class="keyword">this</span>.cypher.segments.return_properties = [<span class="string">'p'</span>];
    }

    <span class="keyword">return</span> <span class="keyword">this</span>.exec(cb);
  }

  Node.prototype.count = <span class="keyword">function</span>(identifier, cb) {
    <span class="keyword">this</span>.cypher.segments._count = <span class="literal">true</span>;
    ...
    <span class="keyword">if</span> (Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &lt; <span class="number">1</span>) {</pre></div></div>
        ...
        <li id="section-50">
            ...
            <div class="content"><div class='highlight'><pre>      <span class="keyword">this</span>.cypher.segments.start[<span class="keyword">this</span>.__TYPE_IDENTIFIER__] = <span class="keyword">this</span>.__TYPE__+<span class="string">'(*)'</span>; <span class="comment">// all nodes by default</span>
    }
    <span class="keyword">this</span>.cypher.segments.count = <span class="string">'COUNT('</span>+((<span class="keyword">this</span>.cypher.segments._distinct) ? <span class="string">'DISTINCT '</span> : <span class="string">''</span>)+identifier+<span class="string">')'</span>;
    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments._distinct)</pre></div></div>
        ...
        <li id="section-51">
            <div class="annotation">
              ...
              <p>set <code>this.cypher.segments._distinct</code> to false</p>
    ...
    <span class="keyword">this</span>._query_history_.push({ count: { distinct: <span class="keyword">this</span>.cypher.segments._distinct, identifier: identifier } });
    <span class="keyword">return</span> <span class="keyword">this</span>; <span class="comment">// return self for chaining</span>
  }
  ...
  Node.prototype._prepareQuery = <span class="keyword">function</span>() {
    <span class="keyword">var</span> query = _.extend(<span class="keyword">this</span>.cypher.segments);
    <span class="keyword">var</span> label = (query.label) ? <span class="string">':'</span>+query.label : <span class="string">''</span>;

    <span class="keyword">if</span> ((<span class="keyword">this</span>.cypher.segments.start) &amp;&amp; (<span class="keyword">this</span>.cypher.segments) &amp;&amp; (Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &lt; <span class="number">1</span>)) {
      <span class="keyword">if</span> (_.isNumber(query.from)) {
        query.start = {};
      ...
      <span class="keyword">if</span> (_.isNumber(query.to)) {
    ...
    <span class="keyword">if</span> ((query.return_properties)&amp;&amp;(query.return_properties.constructor === Array)) {
      <span class="keyword">var</span> returnLabels = <span class="literal">null</span>;
      query.return_properties.forEach(<span class="keyword">function</span>(returnProperty){
        <span class="keyword">if</span> ((returnLabels === <span class="literal">null</span>) &amp;&amp; (<span class="regexp">/^n(\s+.*)*$/</span>.test(returnProperty)))
          returnLabels = <span class="literal">true</span>;
      });</pre></div></div>
        ...
        <li id="section-53">
            <div class="annotation">
              ...
              <p>but we don&#39;t return labels if we have an action like DELETE</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      <span class="keyword">if</span> ((returnLabels) &amp;&amp; (!query.action))
        query.return_properties.push(<span class="string">'labels(n)'</span>);
...
to avoid s.th. like `RETURN COUNT(</em>), n, r`</p>
      ...
      <span class="keyword">if</span> (query.match.length === <span class="number">0</span>) {</pre></div></div>
        ...
        <li id="section-56">
            <div class="annotation">
              ...
              <p>this.cypher.segments can be an ID or a label</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>        query.match.push(<span class="string">'(n'</span>+label+<span class="string">')'</span>+x+<span class="string">'[r'</span>+relationships+<span class="string">']'</span>+y+<span class="string">'('</span>+( (<span class="keyword">this</span>.cypher.segments.to &gt; <span class="number">0</span>) ? <span class="string">'m'</span> : ( (<span class="keyword">this</span>.cypher.segments.to) ? <span class="keyword">this</span>.cypher.segments.to.replace(<span class="regexp">/^\:*(.*)$/</span>,<span class="string">':$1'</span>) : <span class="string">''</span> ) ) +<span class="string">')'</span>);
      }
    }
...
e.g. START n = node(*), a = node(2) WHERE … RETURN (~&gt;) n, a;</p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> ((!query.return_properties)||((query.return_properties)&amp;&amp;(query.return_properties.length == <span class="number">0</span>)&amp;&amp;(<span class="keyword">this</span>.cypher.segments.start)&amp;&amp;(Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &gt; <span class="number">0</span>))) {
    ...
    <span class="keyword">if</span> ((!(query.match.length&gt;<span class="number">0</span>))&amp;&amp;(<span class="keyword">this</span>.label)) {</pre></div></div>
        ...
        query.match = [ <span class="string">'(n:'</span>+<span class="keyword">this</span>.label+<span class="string">')'</span> ];
      <span class="keyword">else</span> <span class="keyword">if</span> (<span class="keyword">this</span>.__TYPE_IDENTIFIER__ === <span class="string">'r'</span>)
        query.match = [ <span class="string">'[r:'</span>+<span class="keyword">this</span>.label+<span class="string">']'</span> ];
    }</pre></div></div>
        ...
        <li id="section-59">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> ((<span class="keyword">this</span>.cypher.segments.start) &amp;&amp; (Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &lt; <span class="number">1</span>)&amp;&amp;(!(query.match.length &gt; <span class="number">0</span>))) {</pre></div></div>
        ...
        <li id="section-60">
            <div class="annotation">
              ...
              <p>query.start = &#39;n = node(*)&#39;;
leave out if a <code>MATCH</code> is defined (will speed up query in some cases)</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      <span class="keyword">if</span> (query.match.length &gt; <span class="number">0</span>) {
        query.start = <span class="string">''</span>;
      } <span class="keyword">else</span> {
        query.start[<span class="keyword">this</span>.__TYPE_IDENTIFIER__] = <span class="keyword">this</span>.__TYPE__+<span class="string">'(*)'</span>;
      }
        ...
        <li id="section-61">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> (_.isNumber(query.by_id)) {</pre></div></div>
        ...
        <li id="section-62">
            <div class="annotation">
              ...
              <p>put in where clause if one or no START statement exists</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      <span class="keyword">if</span> (Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &lt;= <span class="number">1</span>) {
        <span class="keyword">var</span> id = query.by_id;
        <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.useParameters) {
          <span class="keyword">this</span>.cypher.segments.start.n = <span class="string">'node({_node_id_})'</span>;
          <span class="keyword">this</span>.cypher.addParameter( { _node_id_: id } );
        } <span class="keyword">else</span> {
          <span class="keyword">this</span>.cypher.segments.start.n = <span class="string">'node('</span>+id+<span class="string">')'</span>;
        }
        ...
        <li id="section-64">
            ...
            <div class="content"><div class='highlight'><pre>      _.uniq(query.hasProperty).forEach(<span class="keyword">function</span>(property) {
        query.where.unshift(<span class="string">'HAS ('</span>+property+<span class="string">')'</span>);
      });</pre></div></div>
        ...
        <li id="section-65">
            <div class="annotation">
              ...
              <p>remove all duplicate-AND-conditions</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      query.where = _.unique(query.where);
    }
  ...
  Node.prototype.toQuery = <span class="keyword">function</span>() {
    <span class="keyword">if</span> (<span class="keyword">this</span>.hasId() &amp;&amp; (!(Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &gt; <span class="number">1</span>))) {
      <span class="keyword">return</span> Node.findById(<span class="keyword">this</span>._id_).toQuery();
    }
    <span class="keyword">var</span> query = <span class="keyword">this</span>._prepareQuery();
    <span class="keyword">var</span> graph = Graph.start(query.start_as_string);
    <span class="keyword">if</span> (query.match.length &gt; <span class="number">0</span>) {
      <span class="keyword">if</span> (<span class="keyword">this</span>.cypher._optionalMatch)
        graph.optionalMatch(query.match.join(<span class="string">' AND '</span>));
      <span class="keyword">else</span>
    ...
    graph.cypher.parameters = <span class="keyword">this</span>.cypher.parameters;
    <span class="keyword">return</span> graph.toQuery();
  }

  Node.prototype.toQueryString = <span class="keyword">function</span>() {
  ...
  Node.prototype._start_node_id = <span class="keyword">function</span>(fallback) {
    ...
    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.from &gt; <span class="number">0</span>)
      <span class="keyword">return</span> <span class="keyword">this</span>.cypher.segments.from;
    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.by_id)
      <span class="keyword">return</span> <span class="keyword">this</span>.cypher.segments.by_id;
    <span class="keyword">else</span>
  ...
  Node.prototype._end_node_id = <span class="keyword">function</span>(fallback) {
    <span class="keyword">if</span> (<span class="keyword">typeof</span> fallback === <span class="string">'undefined'</span>)
      fallback = <span class="string">'*'</span>
    <span class="keyword">return</span> (<span class="keyword">this</span>.cypher.segments.to &gt; <span class="number">0</span>) ? <span class="keyword">this</span>.cypher.segments.to : fallback;
  }
  ...
  Node.prototype.exec = <span class="keyword">function</span>(cb, cypher_or_request) {
    ...
    <span class="keyword">var</span> cypherQuery = <span class="literal">null</span>;</pre></div></div>
    ...
    <span class="keyword">if</span> (<span class="keyword">typeof</span> cb === <span class="string">'function'</span>) {
      <span class="keyword">this</span>.cypher.parameters = <span class="keyword">this</span>.toQuery().parameters;
      <span class="keyword">return</span> <span class="keyword">this</span>.query(<span class="keyword">this</span>.toCypherQuery(), cb);
    }
    <span class="keyword">return</span> <span class="keyword">this</span>;
  }

  Node.prototype.query = <span class="keyword">function</span>(cypherQuery, parameters, cb, options) {
    <span class="keyword">var</span> self = <span class="keyword">this</span>;
    ...
    options.cypher = _.extend(<span class="keyword">this</span>.cypher.segments, { parameters: <span class="keyword">this</span>.cypher.parameters });
    ...
    <span class="keyword">var</span> graph = Graph.start();</pre></div></div>
        ...
        <li id="section-68">
            <div class="annotation">
              ...
              <p>of loading is deactivated on Node, disable on Graph here as well</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> (!<span class="keyword">this</span>.load)
      graph.disableLoading();</pre></div></div>
    ...
    <span class="keyword">if</span> ((<span class="keyword">this</span>.cypher.useParameters) &amp;&amp; (<span class="keyword">this</span>.cypher.hasParameters()) &amp;&amp; (Object.keys(<span class="keyword">this</span>.cypher.parameters).length &gt; <span class="number">0</span>)) {
      graph.setParameters(<span class="keyword">this</span>.cypher.parameters);
    }
...
in stream case we use stream() instead of query()</p>
        ...
        <span class="keyword">return</span> graph.stream(cypherQuery, parameters, cb, options);
      } <span class="keyword">else</span> {
        <span class="keyword">return</span> graph.query(cypherQuery, parameters, cb, options);
      }
...
with the feature of process node data</p>
  ...
  Node.prototype.withRelations = <span class="keyword">function</span>(relation, cb) {
    ...
    self._query_history_.push({ withRelation: <span class="literal">true</span> });</pre></div></div>
        ...
        <li id="section-73">
            ...
            <div class="content"><div class='highlight'><pre>    self.cypher.segments.relationship = (<span class="keyword">typeof</span> relation === <span class="string">'string'</span>) ? relation : relation.join(<span class="string">'|'</span>);
    self.cypher.segments.incoming = <span class="literal">true</span>;
    self.cypher.segments.outgoing = <span class="literal">true</span>;
    self.exec(cb);
  ...
  Node.prototype.incomingRelations = <span class="keyword">function</span>(relation, cb) {
    ...
    self.cypher.segments.node_identifier = <span class="string">'n'</span>;</pre></div></div>
        ...
        <li id="section-74">
            <div class="annotation">
              ...
              <p>self.cypher.segments.start = {};</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    self.cypher.segments.start.n = <span class="string">'node('</span>+self._start_node_id(<span class="string">'*'</span>)+<span class="string">')'</span>;
    <span class="keyword">if</span> (self.cypher.segments.to &gt; <span class="number">0</span>)
      self.cypher.segments.start.m = <span class="string">'node('</span>+self._end_node_id(<span class="string">'*'</span>)+<span class="string">')'</span>;
    self.cypher.segments.incoming = <span class="literal">true</span>;
    self.cypher.segments.outgoing = <span class="literal">false</span>;
    self.cypher.segments.return_properties = [<span class="string">'r'</span>];
    self.exec(cb);
    <span class="keyword">return</span> self; <span class="comment">// return self for chaining</span>
  }
  ...
  Node.prototype.outgoingRelations = <span class="keyword">function</span>(relation, cb) {
    ...
    <span class="keyword">if</span> (self.cypher.segments.to &gt; <span class="number">0</span>)
      self.cypher.segments.start.m = <span class="string">'node('</span>+self._end_node_id(<span class="string">'*'</span>)+<span class="string">')'</span>;
    self.cypher.segments.incoming = <span class="literal">false</span>;
    self.cypher.segments.outgoing = <span class="literal">true</span>;
    self.cypher.segments.return_properties = [<span class="string">'r'</span>];
    self.exec(cb);
    <span class="keyword">return</span> self; <span class="comment">// return self for chaining</span>
  ...
  Node.prototype.incomingRelationsFrom = <span class="keyword">function</span>(node, relation, cb) {
    ...
    self.cypher.segments.from = self.id || <span class="literal">null</span>;</pre></div></div>
        ...
        <li id="section-76">
            <div class="annotation">
              ...
              <p>node can be a number or a label string: <code>123</code> | <code>Person</code></p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    self.cypher.segments.to = helpers.getIdFromObject(node) || node;
    <span class="keyword">if</span> (<span class="keyword">typeof</span> relation !== <span class="string">'function'</span>)
      self.cypher.segments.relationship = relation;
    self.cypher.segments.return_properties = [<span class="string">'r'</span>];
  ...
  Node.prototype.outgoingRelationsTo = <span class="keyword">function</span>(node, relation, cb) {
    <span class="keyword">var</span> self = <span class="keyword">this</span>.singletonForQuery();
    self._query_history_.push({ outgoingRelationshipsTo: <span class="literal">true</span> }); <span class="comment">// only as a ”flag”</span></pre></div></div>
  ...
  Node.prototype.allDirections = <span class="keyword">function</span>(relation, cb) {
    ...
    <span class="keyword">if</span> (<span class="keyword">typeof</span> relation !== <span class="string">'function'</span>)
      self.cypher.segments.relationship = relation;
    self.cypher.segments.node_identifier = <span class="string">'n'</span>;
    self.cypher.segments.start.n = <span class="string">'node('</span>+self._start_node_id(<span class="string">'*'</span>)+<span class="string">')'</span>;
    self.cypher.segments.start.m = <span class="string">'node('</span>+self._end_node_id(<span class="string">'*'</span>)+<span class="string">')'</span>;
    self.cypher.segments.incoming = <span class="literal">true</span>;
    self.cypher.segments.outgoing = <span class="literal">true</span>;
    self.cypher.segments.return_properties = [<span class="string">'n'</span>, <span class="string">'m'</span>, <span class="string">'r'</span>];
    self.exec(cb);
    <span class="keyword">return</span> self; <span class="comment">// return self for chaining</span>
  }
  ...
  Node.prototype.allRelations = <span class="keyword">function</span>(relation, cb) {
    <span class="keyword">var</span> self = <span class="keyword">this</span>.singletonForQuery();
    <span class="keyword">var</span> label = (<span class="keyword">this</span>.cypher.segments.label) ? <span class="string">':'</span>+<span class="keyword">this</span>.cypher.segments.label : <span class="string">''</span>;
    ...
    self.cypher.segments.match = [ <span class="string">'(n'</span>+label+<span class="string">')-[r'</span>+relation+<span class="string">']-()'</span> ];
    self.cypher.segments.return_properties = [<span class="string">'r'</span>];
    self.exec(cb);
    <span class="keyword">return</span> self; <span class="comment">// return self for chaining</span>
  }
  ...
  Node.prototype.limit = <span class="keyword">function</span>(limit, cb) {
    ...
    <span class="keyword">this</span>.cypher.segments.limit = parseInt(limit);
    ...
    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.action === <span class="string">'DELETE'</span>)
  ...
  Node.prototype.skip = <span class="keyword">function</span>(skip, cb) {
    <span class="keyword">this</span>.cypher.segments.skip = parseInt(skip);
    ...
    <span class="keyword">this</span>._query_history_.push({ SKIP: <span class="keyword">this</span>.cypher.segments.skip });
    <span class="keyword">this</span>.exec(cb);
    <span class="keyword">return</span> <span class="keyword">this</span>; <span class="comment">// return self for chaining</span>
  }
  ...
  Node.prototype.distinct = <span class="keyword">function</span>(cb, value) {
    ...
    <span class="keyword">this</span>.cypher.segments._distinct = value;
  ...
  Node.prototype.orderBy = <span class="keyword">function</span>(property, cb, identifier) {
    ...
    <span class="keyword">if</span> (<span class="keyword">typeof</span> property === <span class="string">'object'</span>) {
      ...
      <span class="keyword">if</span> ( (<span class="keyword">typeof</span> direction === <span class="string">'string'</span>) &amp;&amp; ((<span class="regexp">/^(ASC|DESC)$/</span>).test(direction)) ) {
        <span class="keyword">this</span>.cypher.segments.order_direction = direction;
      }
...
we use 1:1 the string</p>
            ...
            <div class="content"><div class='highlight'><pre>      <span class="keyword">this</span>.cypher.segments.order_by = property;
...
escape property</p>
            ...
            <div class="content"><div class='highlight'><pre>      <span class="keyword">this</span>.cypher.segments.order_by = identifier + <span class="string">".`"</span>+property+<span class="string">"`"</span>;
    } <span class="keyword">else</span> {</pre></div></div>
    ...
    <span class="keyword">this</span>._query_history_.push({ ORDER_BY: <span class="keyword">this</span>.cypher.segments.order_by });
    <span class="keyword">this</span>.exec(cb);
    <span class="keyword">return</span> <span class="keyword">this</span>; <span class="comment">// return self for chaining</span>
  }
...
<p>e.g.: &#39;p:PERSON-[:KNOWS|:FOLLOWS]-&gt;a:Actor-[:ACTS]-&gt;m&#39;</p>
    ...
    <span class="keyword">this</span>.cypher.segments.match.push(string);
    <span class="keyword">this</span>.exec(cb);
    <span class="keyword">return</span> <span class="keyword">this</span>; <span class="comment">// return self for chaining</span>
  }</pre></div></div>
...
e.g. as array: [ &#39;award.name AS Award&#39;, &#39;awardee.name AS WonBy&#39; ]</p>
    ...
    <span class="keyword">if</span> (returnStatement) {
      <span class="keyword">this</span>.cypher.segments.return_properties = <span class="keyword">this</span>.cypher.segments.return_properties.concat(
        (returnStatement.constructor === Array) ? returnStatement : returnStatement.split(<span class="string">', '</span>)
      );
      <span class="keyword">this</span>._query_history_.push({ RETURN: <span class="keyword">this</span>.cypher.segments.return_properties });
    }
    <span class="keyword">this</span>.exec(cb);
    <span class="keyword">return</span> <span class="keyword">this</span>; <span class="comment">// return self for chaining</span>
  }</pre></div></div>
    ...
    <span class="keyword">if</span> (self.label)
      self.withLabel(self.label);</pre></div></div>
      ...
      self.cypher.segments.start = <span class="literal">null</span>;
    <span class="keyword">else</span>
  ...
  Node.prototype.where = <span class="keyword">function</span>(where, cb, options) {
    ...
    <span class="keyword">if</span> (<span class="keyword">typeof</span> options.identifier !== <span class="string">'string'</span>)</pre></div></div>
        ...
        <li id="section-88">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">if</span> (_.indexOf(<span class="keyword">this</span>.cypher.segments.return_properties, options.identifier) === -<span class="number">1</span>)
      <span class="keyword">this</span>.cypher.segments.return_properties.push(options.identifier);


    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.start) {
      <span class="keyword">if</span> (!<span class="keyword">this</span>.cypher.segments.start.n)
        <span class="keyword">this</span>.cypher.segments.start.n = <span class="string">'node(*)'</span>;
      <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.start.m)
        <span class="keyword">this</span>.cypher.segments.start.m = <span class="string">'node(*)'</span>;
      <span class="keyword">if</span> (options.identifier === <span class="string">'r'</span>)
        <span class="keyword">this</span>.cypher.segments.start.r = <span class="string">'relationship(*)'</span>;
    }</pre></div></div>
...
<a href="http://docs.neo4j.org/chunked/stable/rest-api-cypher.html">http://docs.neo4j.org/chunked/stable/rest-api-cypher.html</a></p>
      ...
      options.valuesToParameters = Boolean(<span class="keyword">this</span>.cypher.useParameters);</pre></div></div>
    ...
    <span class="keyword">var</span> condition = <span class="keyword">new</span> ConditionalParameters(_.extend(where), options);
    <span class="keyword">var</span> whereCondition = condition.toString();
    <span class="keyword">this</span>.cypher.segments.where.push(whereCondition);
    <span class="keyword">if</span> ((options.valuesToParameters) &amp;&amp; (condition.hasParameters()))
      <span class="keyword">this</span>._addParametersToCypher(condition.values());
  ...
  Node.prototype.andHasProperty = <span class="keyword">function</span>(property, identifier, cb) {
    ...
    <span class="keyword">if</span> (<span class="regexp">/^[nmr]\./</span>.test(property))</pre></div></div>
      ...
      <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.return_properties.length === <span class="number">0</span>) {
        ...
        identifier = <span class="keyword">this</span>.cypher.segments.return_properties[<span class="keyword">this</span>.cypher.segments.return_properties.length-<span class="number">1</span>];
      <span class="keyword">this</span>.cypher.segments.hasProperty.push(identifier+<span class="string">'.`'</span>+property+<span class="string">'`'</span>);
  ...
  Node.prototype.<span class="keyword">delete</span> = <span class="keyword">function</span>(cb) {
    <span class="keyword">if</span> (<span class="keyword">this</span>.hasId()) {
      <span class="keyword">throw</span> Error(<span class="string">'To delete a node, use remove(). delete() is for queries'</span>);
    }
    <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.limit) {
      <span class="keyword">throw</span> Error(<span class="string">"You can't use a limit on a DELETE, use WHERE instead to specify your limit"</span>);
    }
    <span class="keyword">this</span>._query_history_.push({ DELETE: <span class="literal">true</span> });
    <span class="keyword">this</span>.cypher.segments.action = <span class="string">'DELETE'</span>;
    <span class="keyword">return</span> <span class="keyword">this</span>.exec(cb);
  }
  ...
  Node.prototype.deleteIncludingRelations = <span class="keyword">function</span>(cb) {
    ...
    <span class="keyword">if</span> (Object.keys(<span class="keyword">this</span>.cypher.segments.start).length &lt; <span class="number">1</span>) {
      <span class="keyword">this</span>.cypher.segments.start[<span class="keyword">this</span>.__TYPE_IDENTIFIER__] = <span class="keyword">this</span>.__TYPE__+<span class="string">"(*)"</span>;
    }
    <span class="keyword">this</span>.cypher._optionalMatch = <span class="literal">true</span>;
    <span class="keyword">this</span>.cypher.segments.match = [ <span class="string">'('</span>+<span class="keyword">this</span>.__TYPE_IDENTIFIER__+label+<span class="string">")-[r]-()"</span> ];
    <span class="keyword">this</span>.cypher.segments.return_properties = [ <span class="string">"n"</span>, <span class="string">"r"</span> ];
  ...
  Node.prototype.remove = <span class="keyword">function</span>(cb) {
    ...
    <span class="keyword">this</span>.onBeforeRemove(<span class="keyword">function</span>(<span class="comment">/*err*/</span>) {
      ...
      <span class="keyword">if</span> (self.hasId()) {
        <span class="keyword">return</span> Graph.start(<span class="string">'n = node({id}) DELETE n'</span>, { id: self.id }, cb);
      }
    })
    <span class="keyword">return</span> <span class="keyword">this</span>;
  }
  ...
  Node.prototype.removeRelations = <span class="keyword">function</span>(type, cb, _options) {
    ...
    <span class="keyword">if</span> ((<span class="keyword">this</span>.hasId())&amp;&amp;(<span class="keyword">typeof</span> cb === <span class="string">'function'</span>)) {
      ...
      Node.findById(<span class="keyword">this</span>.id)[direction+<span class="string">'Relations'</span>]().<span class="keyword">delete</span>(cb);
    } <span class="keyword">else</span> {
  ...
  Node.prototype.createRelation = <span class="keyword">function</span>(options, cb) {
    <span class="keyword">var</span> self = <span class="keyword">this</span>;
    options = _.extend({
      from_id: <span class="keyword">this</span>._id_,
    ...
    <span class="keyword">if</span> ((_.isNumber(options.from_id))&amp;&amp;(_.isNumber(options.to_id))&amp;&amp;(<span class="keyword">typeof</span> cb === <span class="string">'function'</span>)) {
      <span class="keyword">if</span> (options.distinct) {
        ...
        <li id="section-97">
            ...
            <div class="content"><div class='highlight'><pre>            Node.Relationship.findById(result[<span class="number">0</span>].id, <span class="keyword">function</span>(err, relationship){
        ...
        <li id="section-98">
            ...
            <div class="content"><div class='highlight'><pre>            Node.Relationship.create(options.type, options.properties, options.from_id, options.to_id, cb);
            <span class="keyword">return</span> self;
          }
        });
      } <span class="keyword">else</span> {</pre></div></div>
...
we have to create the relationships sequentially</p>
  ...
  Node.prototype.setId = <span class="keyword">function</span>(id) {
  ...
  Node.prototype.setLabels = <span class="keyword">function</span>(labels) {
    <span class="keyword">if</span> (<span class="keyword">typeof</span> labels === <span class="string">'string'</span>) {
      labels = [ labels ];
    }
  ...
  Node.prototype.allLabels = <span class="keyword">function</span>(cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.requestLabels(cb);
  }
  ...
  Node.prototype.replaceLabels = <span class="keyword">function</span>(labels, cb) {
    ...
    <span class="keyword">if</span> ( (<span class="keyword">this</span>.hasId()) &amp;&amp; (_.isFunction(cb)) ) {
      <span class="keyword">if</span> (!_.isArray(labels))
        labels = [ labels ];
      self.labels = labels;
      Graph.request().put(<span class="string">'node/'</span>+self.id+<span class="string">'/labels'</span>, { data: labels }, cb);
    }
    <span class="keyword">return</span> <span class="keyword">this</span>;
  }
  ...
  Node.prototype.findOne = <span class="keyword">function</span>(where, cb) {
    ...
    self.cypher.segments.limit = <span class="number">1</span>;
    <span class="keyword">return</span> self.exec(cb);
  }
  ...
  Node.prototype.findById = <span class="keyword">function</span>(id, cb) {
    ...
    <span class="keyword">var</span> self = <span class="keyword">this</span>;
    <span class="keyword">if</span> (isNaN(id)) {
      <span class="keyword">throw</span> Error(<span class="string">'You have to give a numeric id as argument'</span>);
    }
    <span class="keyword">this</span>._query_history_.push({ findById: id });
    <span class="keyword">this</span>.cypher.segments.by_id = Number(id);
    <span class="keyword">var</span> identifier = <span class="keyword">this</span>.cypher.segments.node_identifier || <span class="keyword">this</span>.__TYPE_IDENTIFIER__;
    <span class="keyword">this</span>.cypher.segments.return_properties = [ identifier ];
    <span class="keyword">if</span> (<span class="keyword">typeof</span> cb === <span class="string">'function'</span>) {
      <span class="keyword">return</span> <span class="keyword">this</span>.exec(<span class="keyword">function</span>(err, found, debug) {
        <span class="keyword">if</span> ( (err) &amp;&amp; (err.exception) &amp;&amp; (self.ignoreExceptionPattern) &amp;&amp; (self.ignoreExceptionPattern.test(err.exception)) ) {
          <span class="keyword">return</span> cb(<span class="literal">null</span>, <span class="literal">null</span>, debug);
        }
        <span class="keyword">if</span> (found) {
          <span class="keyword">if</span> (found.length &gt; <span class="number">1</span>) {
            <span class="keyword">return</span> cb(Error(<span class="string">'More than one result rows on findById… expected only one distinct result'</span>), found, debug);
          }
    ...
    <span class="keyword">return</span> <span class="keyword">this</span>.findByKeyValue({ id: id });
  }
  ...
  Node.prototype.findByKeyValue = <span class="keyword">function</span>(key, value, cb, _limit_) {
    <span class="keyword">if</span> (<span class="keyword">typeof</span> _limit_ === <span class="string">'undefined'</span>)
      _limit_ = <span class="literal">null</span>;</pre></div></div>
...
{ key: value }</p>
    ...
    <span class="keyword">if</span> ( (_.isString(key)) &amp;&amp; (<span class="keyword">typeof</span> value !== <span class="string">'undefined'</span>) ) {
      <span class="keyword">this</span>._query_history_.push({ findByKeyValue: <span class="literal">true</span> });
      <span class="keyword">var</span> identifier = <span class="keyword">this</span>.cypher.segments.node_identifier || <span class="keyword">this</span>.__TYPE_IDENTIFIER__;
      <span class="keyword">if</span> (<span class="keyword">this</span>.cypher.segments.return_properties.length === <span class="number">0</span>)
        <span class="keyword">this</span>.cypher.segments.return_properties = [ identifier ];
      <span class="keyword">if</span> (key !== <span class="string">'id'</span>) {
        ...
        query[key] = value;
        <span class="keyword">this</span>.where(query);
        <span class="keyword">if</span> (<span class="keyword">this</span>.label)
          <span class="keyword">this</span>.withLabel(<span class="keyword">this</span>.label);</pre></div></div>
      ...
      <span class="keyword">if</span> (<span class="keyword">typeof</span> cb === <span class="string">'function'</span>) {
        <span class="keyword">return</span> <span class="keyword">this</span>.exec(<span class="keyword">function</span>(err,found){
          <span class="keyword">if</span> (err)
  ...
  Node.prototype.findAll = <span class="keyword">function</span>(cb) {
    <span class="keyword">this</span>._query_history_.push({ findAll: <span class="literal">true</span> });
    <span class="keyword">this</span>.cypher.segments.limit = <span class="literal">null</span>;
    <span class="keyword">this</span>.cypher.segments.return_properties = [<span class="string">'n'</span>];
    <span class="keyword">if</span> (<span class="keyword">this</span>.label)
      <span class="keyword">this</span>.withLabel(<span class="keyword">this</span>.label);
    <span class="keyword">return</span> <span class="keyword">this</span>.exec(cb);
  }

  Node.prototype.findOrCreate = <span class="keyword">function</span>(where, cb) {
    <span class="keyword">var</span> self = <span class="keyword">this</span>;
    <span class="keyword">this</span>.constructor.find(where).count(<span class="keyword">function</span>(err, count, debug) {
      <span class="keyword">if</span> (err)
   ...
   */</span>
  Node.prototype.singleton = <span class="keyword">function</span>(id, label) {
  ...
  Node.find = <span class="keyword">function</span>(where, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().find(where, cb);
  }

  Node.findAll = <span class="keyword">function</span>(cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().findAll(cb);
  }

  Node.findById = <span class="keyword">function</span>(id, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().findById(id, cb);
  }

  Node.findOne = <span class="keyword">function</span>(where, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().findOne(where, cb);
  }
  ...
  Node.findOrCreate = <span class="keyword">function</span>(where, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().findOrCreate(where, cb);
  }

  Node.findByKeyValue = <span class="keyword">function</span>(key, value, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().findByKeyValue(key, value, cb);
  }

  Node.findOneByKeyValue = <span class="keyword">function</span>(key, value, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().findOneByKeyValue(key, value, cb);
  }

  Node.start = <span class="keyword">function</span>(start, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().start(start, cb);
  }

  Node.query = <span class="keyword">function</span>(cypherQuery, parameters, cb, options) {
    <span class="keyword">return</span> <span class="keyword">this</span>.prototype.singleton().query(cypherQuery, parameters, cb, options);
  }
  ...
  Node.registerModel = <span class="keyword">function</span>(Class, label, prototype, cb) {
    ...
    <span class="keyword">var</span> ParentModel = <span class="keyword">this</span>;
...
e.g. indexes, defaults…</p>
  ...
  Node.registeredModel = <span class="keyword">function</span>(model) {
    ...
    <span class="keyword">return</span> Node.registeredModels()[model] || <span class="literal">null</span>;
  }
  ...
  Node.create = <span class="keyword">function</span>(data, id, cb) {
    <span class="keyword">if</span> (<span class="keyword">typeof</span> id === <span class="string">'function'</span>) {
      cb = id;
      id = <span class="literal">undefined</span>;
    }
    <span class="keyword">var</span> node = <span class="keyword">new</span> <span class="keyword">this</span>(data, id);
    <span class="keyword">if</span> (<span class="keyword">typeof</span> cb === <span class="string">'function'</span>)
      <span class="keyword">return</span> node.save(cb);
    <span class="keyword">else</span>
      <span class="keyword">return</span> node;
  }

  Node.<span class="keyword">new</span> = <span class="keyword">function</span>(data, id, cb) {
    <span class="keyword">return</span> <span class="keyword">this</span>.create(data, id, cb);
  }

  Node.setDefaultFields = <span class="keyword">function</span>(fields) {
    <span class="keyword">return</span> <span class="keyword">this</span>._setModelFields(<span class="string">'defaults'</span>, fields);
  }

  Node.setIndexFields = <span class="keyword">function</span>(fields) {
    <span class="keyword">return</span> <span class="keyword">this</span>._setModelFields(<span class="string">'indexes'</span>, fields);
  }

  Node.setUniqueFields = <span class="keyword">function</span>(fields) {
    <span class="keyword">return</span> <span class="keyword">this</span>._setModelFields(<span class="string">'unique'</span>, fields);
  }

  Node._setModelFields = <span class="keyword">function</span>(part, fields) {</pre></div></div>
        ...
        <li id="section-117">
            <div class="annotation">
              ...
              <p>part: defaults|unique|indexes</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="keyword">for</span> (<span class="keyword">var</span> attribute <span class="keyword">in</span> <span class="keyword">this</span>.prototype.fields[part])</pre></div></div>
        ...
        <li id="section-118">
            <div class="annotation">
              ...
              <p>delete previous fields</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>      <span class="keyword">delete</span>(<span class="keyword">this</span>.prototype.fields[part][attribute]);
    <span class="keyword">if</span> ((<span class="keyword">typeof</span> fields === <span class="string">'object'</span>) &amp;&amp; (fields !== <span class="literal">null</span>)) {
      <span class="keyword">for</span> (<span class="keyword">var</span> attribute <span class="keyword">in</span> fields)
        <span class="keyword">this</span>.prototype.fields[part][attribute] = fields[attribute]
    }
    <span class="keyword">return</span> <span class="keyword">this</span>;
  }
