...
<p>Requirements (for browser and nodejs):<br />* neo4jmapper helpers<br />* underscorejs<br />* sequence (<a href='https://github.com/coolaj86/futures'>https://github.com/coolaj86/futures</a>)</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">var __initNode__ = function(neo4jrestful, Graph) {
  ...
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="Node">Node</h1><h5 class="subheader"><div class="label radius ctx-type">function</div>Node()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><h3>Constructor of Node</h3>

<p>Calls this.init(data,id) to set all values to default</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">var Node = function Node(data, id, cb) {
    ...
    if (cb)
      return this.save(cb);
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="init">init</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.init()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Initialize all values on node object</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.init = function(data, id) {
    this.setId(id || null);
    ...
    return this;
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="convertToModel">convertToModel</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.convertToModel()</h5></header><ul class="no-bullet tags"><li class="tag"><span class="type">@param: </span><span class="types">{Function,String}</span><span class="name"></span><span class="description"></span></li></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Instantiate a node from a specific model<br />Model can be a constructor() or a String<br />and must be registered in Node.registered_models()</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.convertToModel = function(model) {
  ...
  Node.prototype.__skip_loading_labels__  = null;   // is used in _onBeforeLoad() to prevent loading labels in an extra request</code></pre></div></div></div></article><article class="comment"><header><h1 id="__TYPE__">__TYPE__</h1><h5 class="subheader"><div class="label radius ctx-type">property</div>Node.prototype.__TYPE__</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Should <strong>never</strong> be changed<br />it's used to dictinct nodes and relationships<br />many queries containg <code>node()</code> command will use this value<br />e.g. n = node(*)</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.__TYPE__                 = 'node';
  ...
  Node.prototype.initialize = function(cb) {
    ...
    if (typeof cb !== 'function')
      cb = function() {</code></pre></div></div></div></article><article class="comment"><header></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>/dev/null</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">};
  ...
  Node.prototype.copyTo = function(n) {
    ...
    return null;
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="resetQuery">resetQuery</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.resetQuery()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Resets the query <strong>but</strong> should not be used since you should start from Node.… instead<br />Anyhow, e.g.:</p>

<p>Example:<br />   n = Node.findOne().where(cb)<br />   n.resetQuery().findOne(otherCb)</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.resetQuery = function() {
  ...
  Node.prototype.fieldsForAutoindex = function() {
    ...
    return keys;
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="uniqueFields">uniqueFields</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.uniqueFields()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Returns all fields that should be unique<br />They need to be defined in your model, e.g.:</p>

<p>Node.register_model({<br /> fields: {<br />   unique: {<br />     email: true<br />   }<br />}});</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.uniqueFields = function() {
    var keys = [];
    ...
    return keys;
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="ensureIndex">ensureIndex</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.ensureIndex()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><h1>Autoindex</h1>

<p>Check the <code>schema</code> of the model and builds an autoindex, optional with unique option<br />see for more details: <a href='http://docs.neo4j.org/chunked/milestone/query-constraints.html'>http://docs.neo4j.org/chunked/milestone/query-constraints.html</a><br />TODO: only via cypher query, to simplify process</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.ensureIndex = function(options, cb) {
    var args;
  ...
  Node.prototype.dropIndex = function(fields, cb) {
    ...
    _.each(fields, function(field) {
      Graph.request().delete(url+'/'+field, function(</code></pre></div></div></div></article><article class="comment"><header></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>err, res</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">{
        done++;
        if (done === todo)
          cb(null, null);
      });
  ...
  Node.prototype.onAfterPopulate = function() {
    return this;
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="withLabel">withLabel</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.withLabel()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Query Methods (via chaining)</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.withLabel = function(label, cb) {
    var self = this;
  ...
  Node.prototype.count = function(identifier, cb) {
    ...
    return this; // return self for chaining
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="_prepareQuery">_prepareQuery</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype._prepareQuery()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Query-Building methods</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype._prepareQuery = function() {
  ...
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="withRelations">withRelations</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.withRelations()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Relationship methods</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.withRelations = function(relation, cb) {
  ...
  Node.prototype.remove = function(cb) {
    var self = this;
    this.onBeforeRemove(function(</code></pre></div></div></div></article><article class="comment"><header></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>rr</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">{
      if (self._is_singleton_)
  ...
  Node.prototype.setId = function(id) {
    ...
    return this;
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="requestLabels">requestLabels</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.requestLabels()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Label methods</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.requestLabels = function(cb) {
    if ((this.hasId())&amp;&amp;(typeof cb === 'function')) {
  ...
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="stream">stream</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.stream()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Request methods</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.stream = function(cb) {
    this._stream_ = true;
    return this.exec(cb);
  }
  ...
  }</code></pre></div></div></div></article><article class="comment"><header><h1 id="find">find</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.find()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>STATIC METHODS for <code>find</code> Queries</p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.find = function(where, cb) {
    var self = this;
    if (!self._is_singleton_)
      self = this.singleton(undefined, this);
  ...
  Node.prototype.findOrCreate = function(where, cb) {
    ...
    return this;
  }</code></pre></div></div></div></article><article class="comment"><header></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Singleton methods, shorthands for their corresponding (static) prototype methods</p></div></div></div></article><article class="comment"><header><h1 id="singleton">singleton</h1><h5 class="subheader"><div class="label radius ctx-type">method</div>Node.prototype.singleton()</h5></header><ul class="no-bullet tags"></ul><div data-section="accordian" data-options="one_up: false;" class="section-container code auto"><div class="section"><p data-section-title class="title"><a href="#">Description</a></p><div data-section-content class="content description"><p>Create a singleton<br />Here a singleton (name may convey a singleton object is as single instance)<br />is a node object that is used as object to use<br />all <code>static</code> methods of the node api.</p>

<p>Example:<br />   <code>Node.singleton().findOne().where()</code></p></div></div><div class="section"><p data-section-title class="title"><a href="#">Source</a></p><div data-section-content class="content"><pre><code class="language-javascript">Node.prototype.singleton = function(id, label) {
